...
public class ControlPanel extends javax.swing.JFrame {
    ...
    UserInfo user;
    ResultSet result;
    private javax.swing.JSpinner dateCheckIn;
    private javax.swing.JSpinner dateCheckOut;
    ...
    public ControlPanel() {
        ...
        dateCheckIn = new javax.swing.JSpinner(checkInModel);
        dateCheckIn.setEditor(new javax.swing.JSpinner.DateEditor(dateCheckIn, "dd/MM/yyyy"));
        
        SpinnerDateModel checkOutModel = new SpinnerDateModel();
        dateCheckOut = new javax.swing.JSpinner(checkOutModel);
        dateCheckOut.setEditor(new javax.swing.JSpinner.DateEditor(dateCheckOut, "dd/MM/yyyy"));
    }
    ...
    private void bookingObjectCreation() {
        ...
        booking.setCheckInDateTime(getDateFromSpinner(dateCheckIn).getTime() / 1000);
        booking.setBookingType((String) comboReservationType.getSelectedItem());
        if (getDateFromSpinner(dateCheckOut) != null) {
            booking.setCheckOutDateTime(getDateFromSpinner(dateCheckOut).getTime() / 1000);
        }
    ...
    private void date_checkInPropertyChange(java.beans.PropertyChangeEvent evt) {
        if (getDateFromSpinner(dateCheckIn) != null) {
            try {
                long date = getDateFromSpinner(dateCheckIn).getTime() / 1000;
    ...
    private void clearAllFields() {
        ...
        tfName.setText("");
        tfRooms.setText("");
        setDateToSpinner(dateCheckIn, new Date());
        setDateToSpinner(dateCheckOut, null);
    ...
    private void setDateToSpinner(JSpinner spinner, Date date) {
